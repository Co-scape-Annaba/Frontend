      ...
      <div className=" flex flex-col items-center justify-center w-11/12">
        <div className=" rounded-xl w-[32rem]">
          <div className="flex flex-col items-center">
            ...
            <img
              src="ico.svg"
              className="w-1/12 mb-4 cursor-pointer"
              alt=""
              onClick={() => {
          ...
          <form onSubmit={formik.handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-2 border border-gray-400 rounded-md p-5 h-9 w-full ${
                  formik.touched.mail && formik.errors.mail && "border-red-500"
                }`}
              />
            </div>
            <div className="flex gap-10">
            ...
            <div className="flex justify-center mt-3">
              <p className="text-xm">
                ...
                <span
                  ...
                  className=" ml-3 font-semibold underline text-primary transition duration-300 ease-in-out w-full cursor-pointer hover:text-primary/80"
                >
                  Connecter-vous
                </span>
              </p>
